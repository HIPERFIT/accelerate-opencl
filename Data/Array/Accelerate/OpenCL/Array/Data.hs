...
-- |
-- Module      : Data.Array.Accelerate.OpenCL.Array.Data
...
--
marshalArrayData :: AD.ArrayElt e => AD.ArrayData e -> CIO [OpenCL.KernelArg]
...
type instance DevicePtrs ty = OpenCL.MemObject ty ;                           \
...
mallocArrayPrim :: forall a b e.
                   ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
...
--
freeArrayPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
...
-- -- Array indexing
-- --
-- indexArrayPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
...
--     OpenCL.peekArray 1 (dp `CUDA.advanceDevPtr` n) p
--     F.peek p


-- -- Copy data between two device arrays.
-- --
-- copyArrayPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
--                  , Storable b, Typeable a, Typeable b)
...
--   src <- getArray src'
--   dst <- getArray dst'
--   liftIO $ OpenCL.copyArrayAsync n src dst


-- Copy data from the device into the associated Accelerate array
--
peekArrayPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject a
...
-- peekArrayAsyncPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject a
--                       , Storable a, Typeable a)
--                    => AD.ArrayData e     -- host array data
--                    -> Int                -- number of elements
...
--
pokeArrayPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject a
                 , Storable a, Typeable a)
              => AD.ArrayData e     -- host array data
              -> Int                -- number of elements
              -> CIO ()
...
-- pokeArrayAsyncPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject a
--                       , Storable a, Typeable a)
...
--
marshalArrayDataPrim :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
                        , Typeable a, Typeable b)
                     => AD.ArrayData e
...
--                           ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject a
...
devicePtrsPrim :: ( AD.ArrayPtrs e ~ Ptr a, AD.ArrayElt e, Typeable a
                  , DevicePtrs e ~ OpenCL.MemObject b, Typeable b)
               => AD.ArrayData e
...
--
arena :: (DevicePtrs e ~ OpenCL.MemObject b, Typeable b)
      => AD.ArrayData e
      -> MemoryEntry
      -> OpenCL.MemObject b
...
-- memory area
--
deleteArray :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
               , Typeable a, Typeable b)
            => AD.ArrayData e
            -> CIO ()
deleteArray ad = do
...
--
getArray :: ( AD.ArrayElt e, AD.ArrayPtrs e ~ Ptr a, DevicePtrs e ~ OpenCL.MemObject b
            , Typeable a, Typeable b)
         => AD.ArrayData e
         -> CIO (OpenCL.MemObject b)
