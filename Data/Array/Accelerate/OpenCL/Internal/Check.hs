{-# LANGUAGE CPP #-}
-- |
-- Module      : Data.Array.Accelerate.Internal.OpenCL.Check
...
module Data.Array.Accelerate.OpenCL.Internal.Check (
...
error file line kind loc msg
  = P.error . unlines $
      (if kind == Internal
         then ([""
               ,"*** Internal error in package accelerate-opencl ***"
               ,"*** Please submit a bug report at https://github.com/HIPERFIT/accelerate-opencl/issues"]++)
         else id)
